#
#  Be sure to run `pod spec lint SystemPermission.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "吴健"
  # s.authors            = { "吴健" => "wujian516411567@.com" }
  # s.social_media_url   = "http://twitter.com/吴健"
  ...
  s.source       = { :git => "https://github.com/weskhen/SystemPermission.git", :tag => "#{s.version}" }
